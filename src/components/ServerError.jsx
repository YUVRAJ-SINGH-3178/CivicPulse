...
function ServerError() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Helmet>
        <title>Server Error | CivicPulse</title>
        <meta name="description" content="We're experiencing technical difficulties. Our team is working to resolve the issue. Please try again or return to CivicPulse homepage." />
