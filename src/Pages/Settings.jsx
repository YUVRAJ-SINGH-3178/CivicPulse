...
const SettingsPage = () => {
  ...
  const [settings, setSettings] = useState({
    systemName: 'CivicPulse Municipal Platform',
    ...
    smtpServer: 'smtp.CivicPulse.gov',
    smtpPort: '587',
    smtpUsername: 'admin@CivicPulse.gov',
    smtpPassword: '',
    emailFromName: 'CivicPulse Administration',
    autoBackup: true,
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-600">Configure and manage your CivicPulse platform</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              {saveStatus === 'saving' && (
