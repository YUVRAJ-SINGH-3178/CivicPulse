    ...
    try {
      ...
      if (profileImageFile) {
        try {
          ...
          const uploadRes = await csrfManager.secureFetch(`${API_BASE_URL}/api/profile/${user.id}/profile-picture`, {
            method: 'POST',
            body: fd
          });
      ...
      const profileResponse = await csrfManager.secureFetch(`${API_BASE_URL}/api/profile/create-or-update`, {
        method: 'POST',
        body: JSON.stringify({
          clerkUserId: user.id,
          email: formData.email,
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-lg mx-auto leading-relaxed">
            Let's personalize your <span className="font-semibold text-emerald-600 dark:text-emerald-400">CivicPulse</span> experience with a few essential details
          </p>
        </div>
