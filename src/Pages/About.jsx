        ...
        <section className="hero-section" data-aos="fade-up">
          <div className="hero-content">
            ...
            <p className="hero-description">
              CivicPulse helps citizens report and track local civic issues like potholes, broken lights,
              ...
              <section className="why-section py-16 px-6 md:px-12 bg-gradient-to-r from-green-600 to-emerald-500 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="300">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
                  <div className="why-text text-white md:w-2/3">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose CivicPulse?</h2>
                    <p className="text-lg opacity-90 leading-relaxed mb-8">
                      CivicPulse empowers citizens by simplifying the process to voice concerns and foster positive
